...
Name = st.text_input("Name of Driver", value=" ", help="Driver Peru", placeholder=None)
Ph_Num = st.text_input("Driver Phone Number", value=" ", help="Diver Phone Number", placeholder=None)
c1,c2 = st.columns(2)
with c1:
  Car_Name = st.selectbox("Car Name", ['baleeno','ertiga','i10','ferare','Bugati','roles Royes'], help='Car Peru')
with c2:
  Car_Num = st.text_input("Car Number", value=" ", help="Car Number Plate", placeholder=None)
Route = st.text_input("Travel Route", value=" ", help="Car Velle Route", placeholder=None)
co1,co2,co3 = st.columns(3)
with co1:
  Loc = st.text_input("Location", value=" ", help="Car Unna Place", placeholder=None)
with co2:
